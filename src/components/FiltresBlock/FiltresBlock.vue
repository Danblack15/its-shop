  ...
  <div class="filtres" @click="closeModal">
    <section :class="['filtres__back', {
      ...
      <div class="filtres__item">
        ...
        <label class="filtres__label" for="new">
      ...
      <div class="filtres__item">
        ...
        <label class="filtres__label" for="have">
          <div class="filtres__condition">
            <span class="filtres__circle"></span>
          </div>
      ...
      <div class="filtres__item">
        ...
        <label class="filtres__label" for="contract">
          <div class="filtres__condition">
            <span class="filtres__circle"></span>
          </div>
      ...
      <div class="filtres__item">
        ...
        <label class="filtres__label" for="exclusive">
          <div class="filtres__condition">
            <span class="filtres__circle"></span>
          </div>
      ...
      <div class="filtres__item">
        ...
        <label class="filtres__label" for="sale">
          <div class="filtres__condition">
            <span class="filtres__circle"></span>
          </div>
